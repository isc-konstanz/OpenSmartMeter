...
@Device(channel = ObisChannel.class)
public abstract class SmartMeterDevice extends DriverDevice {
    ...
    @Option(type = ADDRESS, id = SERIAL_PORT,
            name = "Serial port",
    ...
    @Option(type = SETTING, id = BAUD_RATE,
